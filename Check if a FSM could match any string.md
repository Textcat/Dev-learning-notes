# Check if a FSM could match any string
The code below is from the Udacity course programming language, it check whether a FSM(finite state machine) simulated in python could match anystring or not
#计算机/regex
```python
